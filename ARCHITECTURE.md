...
- Active ownership split inside that seam:
  ...
  - `BacktestResultQueryService`: history, lightweight summary reads, full details, experiment summaries, and comparison DTO mapping
...
- Active backtest polling should prefer the lightweight summary endpoint, while completed-run review can request the heavier detail payload with equity, trade, and telemetry series.
