...
/**
 * Manual verification tool for Bollinger Band signal generation.
 * 
 * This class demonstrates the strategy with sample price data and prints
 * detailed information about Bollinger Bands calculations and generated signals.
 * 
 * Run this class to manually verify:
 * - Bollinger Bands are calculated correctly
 * - BUY signals are generated on lower band bounces
 * - SELL signals are generated at middle band
 * - Stop-loss and take-profit levels are calculated properly
 */
public class ManualSignalVerification {
    
    public static void main(String[] args) {
        System.out.println("=== Bollinger Band Strategy - Manual Signal Verification ===\n");
     ...
     */
    private static void testLowerBandBounce(BollingerBandStrategy strategy) {
        // Create price data with downtrend followed by bounce
        ...
        BigDecimal currentPrice = new BigDecimal("97.5"); // Bouncing up from 96
     ...
     */
    private static void testMiddleBandReached(BollingerBandStrategy strategy) {
     ...
     */
    private static void testNoSignal(BollingerBandStrategy strategy) {
     ...
     */
    private static void testWeakSignal(BollingerBandStrategy strategy) {
     ...
     */
    private static List<BigDecimal> createPriceData(double... prices) {
     ...
     */
    private static void printBollingerBands(BollingerBands bands) {
     ...
     */
    private static void printPriceInfo(BigDecimal currentPrice, BigDecimal previousPrice) {
        System.out.println("\nPrice Information:");
     ...
     */
    private static void printSignal(TradeSignal signal) {
        System.out.println("\nGenerated Signal:");
     ...
     */
    private static void verifyStopLoss(BigDecimal entryPrice, BigDecimal stopLoss) {
