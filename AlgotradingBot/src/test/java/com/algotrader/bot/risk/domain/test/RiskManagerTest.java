...
class RiskManagerTest {
    ...
    @Test
    @DisplayName("Test 1: Sharpe ratio 1.5 Ă˘â€ â€™ trading allowed")
    ...
    @Test
    @DisplayName("Test 2: Sharpe ratio 0.7 for 5 days Ă˘â€ â€™ circuit breaker triggers")
    ...
    @Test
    @DisplayName("Test 3: Drawdown 15% Ă˘â€ â€™ trading allowed")
    ...
    @Test
    @DisplayName("Test 4: Drawdown 26% Ă˘â€ â€™ trading stopped")
    ...
    @Test
    @DisplayName("Test 5: Account status STOPPED Ă˘â€ â€™ canTrade returns false")
    ...
    @Test
    @DisplayName("Test 6: Account status ACTIVE + good metrics Ă˘â€ â€™ canTrade returns true")
    ...
    @Test
    @DisplayName("Test circuit breaker with exactly 4 consecutive low Sharpe days Ă˘â€ â€™ trading allowed")
    ...
    @Test
    @DisplayName("Test drawdown at exactly 25% limit Ă˘â€ â€™ trading allowed")
    ...
    @Test
    @DisplayName("Test canTrade with CIRCUIT_BREAKER_TRIGGERED status Ă˘â€ â€™ trading not allowed")
    ...
    @Test
    @DisplayName("Test checkCircuitBreaker with empty trade list Ă˘â€ â€™ trading allowed")
    ...
    @Test
    @DisplayName("Test checkCircuitBreaker with null trade list Ă˘â€ â€™ trading allowed")
    ...
    @Test
    @DisplayName("Test checkCircuitBreaker with null account Ă˘â€ â€™ throws exception")
    ...
    @Test
    @DisplayName("Test checkDrawdown with null account Ă˘â€ â€™ throws exception")
    ...
    @Test
    @DisplayName("Test canTrade with null account Ă˘â€ â€™ throws exception")
    ...
    @Test
    @DisplayName("Test updateAccountStatus with null account Ă˘â€ â€™ throws exception")
    ...
    @Test
    @DisplayName("Test updateAccountStatus with null status Ă˘â€ â€™ throws exception")
    ...
    @Test
    @DisplayName("Test circuit breaker with trades having no PnL Ă˘â€ â€™ Sharpe ratio is zero")
