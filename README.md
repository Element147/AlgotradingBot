...
The first five new Phase 3 implementations, `OPENING_RANGE_VWAP_BREAKOUT`, `VWAP_PULLBACK_CONTINUATION`, `EXHAUSTION_REVERSAL_FADE`, `MULTI_TIMEFRAME_EMA_ADX_PULLBACK`, and `SQUEEZE_BREAKOUT_REGIME_CONFIRMATION`, are now available as research-only strategies with shared telemetry overlays and frozen pre-code specs at `docs/strategy-specs/OPENING_RANGE_VWAP_BREAKOUT.md`, `docs/strategy-specs/VWAP_PULLBACK_CONTINUATION.md`, `docs/strategy-specs/EXHAUSTION_REVERSAL_FADE.md`, `docs/strategy-specs/MULTI_TIMEFRAME_EMA_ADX_PULLBACK.md`, and `docs/strategy-specs/SQUEEZE_BREAKOUT_REGIME_CONFIRMATION.md`; they are not yet part of the March 27 frozen audit dispositions.
...
- `docs/strategy-specs/SQUEEZE_BREAKOUT_REGIME_CONFIRMATION.md`
